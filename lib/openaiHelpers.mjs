...
import { extractSymbolsFromInput, getGlossaryMap } from './glossary.mjs';
...
// Step 1: Embedding for vector search
...
Modulate your tone to match the user’s emotional style. Example tones: ${toneHint}.
