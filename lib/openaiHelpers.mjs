...
export async function buildFractalPrompt(userInput, matchedChunks = []) {
  ...
  const { scholarBridges, hypothesisThemes } = getRelatedScholars(userInput, symbols);
